/**
 * Created by alphabeta on 17-10-22.
 */
...
class IdCard {
  ...
  //15位转18位身份证号
  static changeFivteenToEighteen(card) {
    if (card.length === 15) {
...
var startDate = '1968-01-01';
var endDate = '1968-12-31';

var self = '130802198602101418';
var start = DateUtil.parse(startDate, 'YYYY-MM-DD');
var end = DateUtil.parse(endDate, 'YYYY-MM-DD')

console.log(IdCard.checkIdCard('330125197601084627'));

for (let day = start.getTime(); day <= end.getTime(); day += 24 * 60 * 60 * 1000) {
  let idCard = prefix + DateUtil.format(new Date(day), 'YYYYMMDD') + suffix;
